      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 sm:px-10 md:grid-cols-2 lg:gap-20 lg:px-16">
        ...
        <div className="text-right">
          ...
          <p className="mt-8 text-[15px] font-normal leading-loose text-white/70 sm:text-base">
            רוב התכשיטים בשוק עשויים פלדת אל-חלד, מתכת תעשייתית זולה לייצור. אצלנו תמצאי כסף סטרלינג 925 אמיתי באיכות הגבוהה ביותר, לכל עומקו, בציפוי רודיום עשיר ויוקרתי שמונע השחרה ושומר על ברק נצחי. זו אותה מתכת יקרה שבה מצפים תכשיטי יהלומים.
          </p>
          <p className="mt-6 text-[15px] font-normal leading-loose text-white/70 sm:text-base">
            הציפוי נטול ניקל, עדין על העור ונוח לענידה יומיומית. בלב הקולקציה עומד מואסנייט בדרגת D/VVS1, אבן בדרגת הצבע והניקיון הגבוהה ביותר, בליטוש Excellent Cut.
          </p>
        </div>
