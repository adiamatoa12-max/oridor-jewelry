...
const STEPS = [
  {
    n: "01",
    title: "מדדי טבעת קיימת",
    body: "קחי טבעת שכבר מתאימה לך בדיוק. הניחי אותה על סרגל ומדדי את הקוטר הפנימי במילימטרים, מקצה פנימי אחד לשני.",
  },
  {
    n: "02",
    title: "או מדדי את האצבע",
    body: "כרכי רצועת נייר דקה או חוט סביב בסיס האצבע. סמני את הנקודה שבה הקצה נפגש, פתחי את הרצועה והניחי אותה לצד סרגל. זהו ההיקף במ״מ.",
  },
  {
    n: "03",
    title: "מצאי את המידה",
    body: "השווי את הקוטר או ההיקף שמדדת לטבלה שלמטה ובחרי את המידה הקרובה ביותר. אם יצא לך בין שתי מידות, עדיף לעגל כלפי מעלה.",
  },
];
    ...
    <section className="mx-auto max-w-4xl px-6 py-20 text-right sm:px-10 lg:px-16 lg:py-28">
      ...
      <header className="text-center">
        ...
        <p className="mx-auto max-w-xl text-sm font-light leading-loose text-graphite">
          מציאת המידה המדויקת פשוטה ולוקחת פחות מדקה. כל מה שצריך הוא טבעת קיימת, או רצועת נייר וסרגל.
        </p>
      </header>
      ...
      <div className="mt-20">
        ...
        <p className="mt-8 text-center text-xs font-light leading-relaxed text-ash">
          עדיין מתלבטת? צרי איתנו קשר בוואטסאפ ונשמח לעזור לך למצוא את המידה המדויקת.
        </p>
      </div>
    </section>
  );
