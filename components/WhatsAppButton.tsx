...
const WHATSAPP_URL =
  ...
  encodeURIComponent("היי, אשמח לקבל פרטים על התכשיטים של Oridor");

/**
 * Floating WhatsApp button — fixed in the bottom corner on every page.
 * Sits below modals (cart/menu) but above page content.
 */
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-cardHover transition-transform duration-300 ease-cinematic hover:scale-110"
    >
