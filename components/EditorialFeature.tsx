  ...
  return (
    <section className="grid w-full grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center bg-canvas p-12 sm:p-16 lg:p-20">
        ...
        <h2 className="max-w-md text-[28px] font-medium leading-tight tracking-[0.08em] text-charcoal sm:text-3xl lg:text-4xl">
          נוצר באהבה, נועד להישאר
        </h2>
        <p className="mt-6 max-w-md text-sm font-light leading-relaxed text-graphite">
          כל פריט נוצר בקפידה מכסף 925 טהור, בעבודת יד מדויקת ובתשומת לב לכל פרט. עיצובים נקיים ועל-זמניים שנועדו ללוות אותך בכל רגע, מהיום-יום ועד הרגעים הבלתי נשכחים.
        </p>
        <Link
          href="/shop"
