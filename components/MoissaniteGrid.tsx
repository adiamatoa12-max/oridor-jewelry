      ...
      {uniqueProducts.map((p) => (
        ...
        >
          ...
          <div className="px-2 pt-4 text-center">
            <h3 className="text-[13px] font-light leading-snug tracking-wide text-charcoal sm:text-sm md:text-base">{p.name}</h3>
            <p className="mt-2 text-[13px] font-light text-neutral-600 sm:text-sm">{formatPrice(p.price)}</p>
          </div>
        </Link>
      ))}
    </div>
