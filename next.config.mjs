...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      // "טבעת אינסוף פאווה" (newarrival-10) was removed from the store. Redirect
      // its retired product URL to the silver collection so no link/SEO 404s.
      {
        source: "/collections/new/newarrival-10",
        destination: "/collections/silver",
        permanent: true,
      },
      ...
      {
        source: "/collections/silver/silver-3",
        destination: "/collections/silver",
        permanent: true,
      },
      // "עגילי הילה טיפה" (newarrival-12) was removed from the store. Redirect
      // its retired product URL to the silver collection so no link/SEO 404s.
      {
        source: "/collections/new/newarrival-12",
        destination: "/collections/silver",
        permanent: true,
      },
      // "עגילי לב ושרשרת" (silver-44) was removed from the store. Redirect its
      // retired product URL to the silver collection so no link/SEO 404s.
      {
        source: "/collections/silver/silver-44",
        destination: "/collections/silver",
        permanent: true,
      },
