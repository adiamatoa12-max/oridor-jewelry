...
export const metadata: Metadata = {
  title: "אחריות ואיכות",
  description:
    "הבטחת האיכות של Oridor — מואסנייט בדרגת D / VVS1 וליטוש מושלם, תעודת אותנטיות GRA, כסף סטרלינג 925 בציפוי רודיום אנטי-החלדה ואחריות לכל החיים.",
...
const PILLARS = [
  {
    ...
    body: "אנו בוחרים אך ורק אבני מואסנייט מובחרות — צבע D (לבן צח לחלוטין), ניקיון VVS1 וליטוש בדרגת Excellent. התוצאה היא ברק יוצא דופן ואש שמתחרה ביהלום טבעי, בכל תאורה. אבן על-זמנית, אתית ועמידה, שנועדה להאיר לנצח.",
  },
  {
    icon: ScrollText,
    eyebrow: "האותנטיות",
    title: "תעודת GRA לכל תכשיט",
    body: "כל פריט מגיע עם תעודת GRA (Gemological Research Association) המאמתת את מקוריות ודרגת אבן המואסנייט. התעודה היא הביטחון שלך: הוכחה רשמית שמה שאת עונדת הוא בדיוק מה שהובטח — ללא פשרות וללא תחליפים.",
  },
  {
    icon: Sparkles,
    eyebrow: "המתכת",
    title: "כסף 925 בציפוי רודיום",
    body: "בסיס כל תכשיט הוא כסף סטרלינג 925 טהור לכל עומקו — מתכת יקרה אמיתית, לא ציפוי על מתכת זולה. מעליו אנו מוסיפים שכבת רודיום יוקרתית המעניקה ברק לבן עז, הגנה מפני שריטות ועמידות אנטי-החלדה — כך התכשיט נשאר מבריק לאורך שנים.",
  },
  {
    icon: ShieldCheck,
    eyebrow: "השקט הנפשי",
    title: "אחריות לכל החיים",
    body: "אנו עומדים מאחורי כל פריט שאנו יוצרים. כל תכשיט מכוסה באחריות לכל החיים כנגד פגמי ייצור, וכל הזמנה מגיעה באריזת מתנה יוקרתית. ניתן להחזיר או להחליף תוך 14 יום ממועד הקבלה — כדי שתוכלי לרכוש בביטחון מוחלט.",
  },
];
    ...
    <main>
      ...
      <section className="mx-auto max-w-4xl px-6 py-24 text-center sm:px-10 lg:px-16 lg:py-32">
        ...
        <p className="mx-auto max-w-xl font-sans text-[15px] font-light leading-relaxed text-graphite">
          ב-Oridor יוקרה אמיתית מתחילה באמת. כל תכשיט נוצר מחומרים מובחרים, מלווה
          בתעודת אותנטיות ומגובה באחריות לכל החיים — כדי שתוכלי לענוד אותו בביטחון
          מוחלט, לתמיד.
        </p>
      </section>
      ...
      <section className="bg-canvas">
        <div className="mx-auto max-w-3xl px-6 py-20 text-center sm:px-10 lg:py-24">
          ...
          <p className="mx-auto mt-5 max-w-xl font-sans text-[15px] font-light leading-relaxed text-graphite">
            אנו יוצרים תכשיטים שנועדו ללוות אותך שנים — ומגבים אותם בהתאם. אם
            מסיבה כלשהי אינך מרוצה לחלוטין, אנחנו כאן. זו ההבטחה של Oridor.
          </p>
