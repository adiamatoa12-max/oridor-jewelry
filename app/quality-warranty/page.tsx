...
export const metadata: Metadata = {
  title: "אחריות ואיכות",
  description:
    "הבטחת האיכות של Oridor — מואסניט בדרגת D / VVS1 וליטוש מושלם, תעודת אותנטיות GRA, כסף סטרלינג 925 בציפוי רודיום אנטי-החלדה ואחריות לכל החיים.",
...
const PILLARS = [
  {
    ...
    body: "אנו בוחרים אך ורק אבני מואסניט מובחרות — צבע D (לבן צח לחלוטין), ניקיון VVS1 וליטוש בדרגת Excellent. התוצאה היא ברק יוצא דופן ואש שמתחרה ביהלום טבעי, בכל תאורה. אבן על-זמנית, אתית ועמידה, שנועדה להאיר לנצח.",
  },
  {
    icon: ScrollText,
    eyebrow: "האותנטיות",
    title: "תעודת GRA לכל תכשיט",
    body: "כל פריט מגיע עם תעודת GRA (Gemological Research Association) המאמתת את מקוריות ודרגת אבן המואסניט. התעודה היא הביטחון שלך: הוכחה רשמית שמה שאת עונדת הוא בדיוק מה שהובטח — ללא פשרות וללא תחליפים.",
  },
  {
    icon: Sparkles,
    eyebrow: "המתכת",
