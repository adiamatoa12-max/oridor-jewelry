...
export const metadata: Metadata = {
  ...
  description:
    "סטים מעוצבים שנבחרו יחד — שרשרת, צמיד, עגילים וטבעת בכסף 925 עם מואסנייט. מוכנים לעטות לרגעים הגדולים. משלוח חינם ואחריות מלאה.",
    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-6 pt-20 text-center sm:px-10 lg:pt-28">
        ...
        <p className="mx-auto mt-4 max-w-md text-sm font-light text-graphite">
          סטים תואמים שנבחרו יחד — שרשרת, צמיד, עגילים וטבעת — לרגעים הגדולים
          ולאירועים הבלתי נשכחים.
        </p>
      </section>
