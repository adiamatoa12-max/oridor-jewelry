...
const FAQS = [
  ...
  },
  {
    ...
    a: "אנחנו אורזים ושולחים כל הזמנה במהירות האפשרית. משלוח עם שליח עד הבית מגיע תוך עד 5 ימי עסקים לכל חלקי הארץ, וכל משלוח מלווה במספר מעקב שנשלח אלייך ישירות למייל.",
  },
];
